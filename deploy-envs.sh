...
export AWS_LOAD_BALANCER=targetGroupArn=arn:aws:elasticloadbalancing:us-east-1:025075093992:targetgroup/tg1/b17ba9b7be473c63,loadBalancerName=elb1,containerName=netcoreapps-stackapis,containerPort=5000
